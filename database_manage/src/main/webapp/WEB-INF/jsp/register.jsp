              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="title-box-2">
                    <h1 >
                      <span style="color: #ffffff">Admin Registration</span>
                    </h1>
                  </div>
                  <div>
						
						<form:form action="/register" id="registerform" method="post" modelAttribute="logintable">
							<div style="color:#00ff43"> ${sussesswritten}</div>
							<div style="color:#ff5400"> ${wrongroot}</div>
						...
						<div class="col-md-12 mb-3">
	                           <a href="${pageContext.request.contextPath}/login" ><button class="button button-a button-fixsize button-rouded">login</button></a> 
	                    </div>   
